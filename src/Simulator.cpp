...
Simulator::Simulator(Cities city, int vehicleCount) {
  ...
  std::for_each(
    vehicles.begin(),
    vehicles.end(),
    [&](std::shared_ptr<Vehicle> &vehicles) {
